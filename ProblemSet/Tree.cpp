...
// 126. Word Ladder II
vector<vector<string>> Tree::findLadders(string beginWord, string endWord, vector<string>& wordList) {
...
vector<vector<string>> Tree::findLadders2(string beginWord, string endWord, vector<string>& wordList) {
    vector<vector<string>> res;
    unordered_set<string> wordSet(wordList.begin(), wordList.end());
    if (!wordSet.count(endWord))
        return res;
